...
export class RolesComponent {
  ...
  editRol(id: string) {
    ...
    this.functionsService.navigateTo(`/core/catalogos/edit-rol/true/${id}`)
  ...
  viewRol(id: string) {
    this.functionsService.navigateTo(`/core/catalogos/edit-rol/false/${id}`)

  }

  newRol() {

    this.functionsService.navigateTo('core/catalogos/new-rol')
  }
