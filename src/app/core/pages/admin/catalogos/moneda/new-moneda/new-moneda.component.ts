...
@Component({
  selector: 'app-new-moneda',
  templateUrl: './new-moneda.component.html',
  styleUrls: ['./new-moneda.component.css']
})
export class NewMonedaComponent {
  ADM = environment.ADM
  ...
  onSubmit() {
    ...
    if (this.form.valid) {
      ...
      this.monedasService.crearMoneda(obj).subscribe((resp: any) => {
