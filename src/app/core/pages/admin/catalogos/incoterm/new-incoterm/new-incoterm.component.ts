...
@Component({
  selector: 'app-new-incoterm',
  templateUrl: './new-incoterm.component.html',
  styleUrls: ['./new-incoterm.component.css']
})
export class NewIncotermComponent {
  ADM = environment.ADM
  ...
  onSubmit() {
    ...
    if (this.form.valid) {
      ...
      this.incotermsService.crearIncoterm(obj).subscribe((resp: any) => {
